...
fun InventoryScreenPreview() {
    ...
    val items = listOf(
        ...
        InventoryItem(4L, "Chain Mail", InventoryCategory.ARMOR, 55.0, 1, true, ""),
        InventoryItem(5L, "Shield", InventoryCategory.ARMOR, 6.0, 1, true, ""),
        InventoryItem(6L, "Healing Potion", InventoryCategory.CONSUMABLE, 0.5, 3, false, ""),
        InventoryItem(7L, "Explorer's Pack", InventoryCategory.OTHER, 59.0, 1, false, ""),
